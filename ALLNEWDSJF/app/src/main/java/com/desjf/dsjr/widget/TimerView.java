...
import com.desjf.dsjr.bean.TimeInfobean;
...
public class TimerView extends LinearLayout implements ITimer, ITimer.OnCountTimeListener {
	...
	int defaultColor = Color.parseColor("#1F1F1F");
	...
	public TimerView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		isHour = typedArray.getBoolean(R.styleable.TimerView_textViewIsHour, false);
		typedArray.recycle();
		init();
	}
	...
	public void updateShow(long curTime) {
		...
		TimeInfobean timeInfo = TimeInfobean.make(curTime, isHour);
