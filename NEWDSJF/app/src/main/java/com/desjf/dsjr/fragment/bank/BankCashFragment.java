...
import com.desjf.dsjr.adapter.bankAdapter.BankFundDetailsCashAdapter;
 ...
 * 提现
 */
public class BankCashFragment extends BaseFragment {
    ...
    private BankFundDetailsCashAdapter myFundDetailsAdapter;
...
//        rootView = (View) inflater.inflate(R.layout.fragment_payments, container, false);
    ...
    private void getJyjl() {
        ...
        CallUtil.call(getActivity(), BankHttpUtils.getHttpRequestService().getUserAllMessage(PreferenceCache.getToken(), i + "", maxCount+"","C"), new CallUtil.MyCallListener() {
            @Override
...
//        linearLayoutManager = new LinearLayoutManager(getActivity());
        if(jyRecordModels==null){
            ...
            if (jyRecordModelList.size() != 0) {
                if (i == 1) {
                    myFundDetailsAdapter = new BankFundDetailsCashAdapter(jyRecordModelList, getActivity());
        ...
        rvAccountFundDetails.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE
                        && lastVisibleItem + 1 == myFundDetailsAdapter.getItemCount()&&myFundDetailsAdapter.getItemCount()>=99) {
                    //如果当前i小于总页数，则加载更多
