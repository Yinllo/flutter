...
import com.desjf.dsjr.activity.AccountMyMessageActivity;
...
public class ShouyeNoticeActivity extends BaseActivity {
    ...
    public static ShouyeNoticeActivity mInstance;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shouye_notice);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ll_about_us_message:
                //消息
                Intent intent = new Intent(ShouyeNoticeActivity.this, AccountMyMessageActivity.class);
            ...
            case R.id.ll_about_us_info:
                //公告
                Intent notice_intent = new Intent(ShouyeNoticeActivity.this,AccountMyNoticeActivity.class);
