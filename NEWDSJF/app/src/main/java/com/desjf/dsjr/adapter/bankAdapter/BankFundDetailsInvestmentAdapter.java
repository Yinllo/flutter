...
public class BankFundDetailsInvestmentAdapter extends BaseQuickAdapter<BankAccountFundDetailsModel.ReturnListBean,BaseViewHolder> {
    private Context context;
    public BankFundDetailsInvestmentAdapter(@Nullable List<BankAccountFundDetailsModel.ReturnListBean> data, Context context) {
