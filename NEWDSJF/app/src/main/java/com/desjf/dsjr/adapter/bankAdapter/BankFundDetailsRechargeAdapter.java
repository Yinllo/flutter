...
public class BankFundDetailsRechargeAdapter extends BaseQuickAdapter<BankAccountFundDetailsModel.ReturnListBean,BaseViewHolder> {
    private Context context;
    public BankFundDetailsRechargeAdapter(@Nullable List<BankAccountFundDetailsModel.ReturnListBean> data, Context context) {
