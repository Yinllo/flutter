 ...
 */
public class BrrowDataFragment extends BaseFragment {
...
//        tvContent.setText(Html.fromHtml(investmentInfoModels.getFINANCEDESCRIPTIONLISTW().get(0).getDETAILDESCRIPTION()));
    ...
    private void initWebView(InvestmentInfoModel investmentInfoModel) {
        ...
        tvContent.loadData(investmentInfoModel.getFINANCEDESCRIPTIONLISTW().get(0).getDETAILDESCRIPTION(),"text/html; charset=UTF-8", null);
//        Log.e("TAG22222222", "initWebView: "+ investmentInfoModel.getPRODUCTSDESCRIPTIONLISTW().get(0).getDETAILDESCRIPTION());
    }
