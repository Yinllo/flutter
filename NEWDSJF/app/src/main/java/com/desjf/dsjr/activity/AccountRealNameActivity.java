...
//    EditText etBanksIdcardEmails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_account_real_name);
...
//        getReChargeSmsSecond.execute();
        ...
        BizDataAsyncTask<RechargeSmsModel> getRechargeSms = new BizDataAsyncTask<RechargeSmsModel>() {
            @Override
            protected RechargeSmsModel doExecute() throws ZYException, BizFailure {
                return ChargeBiz.getRealNameSmsSecond(etBanksIdcardPhoneNum.getText().toString(), bank, etBanksIdcard.getText().toString(), etRealName.getText().toString(), etRealId.getText().toString());
            }
    ...
    private void initRealName() {
        ...
        BizDataAsyncTask<String> getRealName = new BizDataAsyncTask<String>() {
            @Override
            protected String doExecute() throws ZYException, BizFailure {
                return AccountBiz.getRealName(etRealName.getText().toString(), etRealId.getText().toString(), etBanksIdcard.getText().toString(), bank, province, city, etBanksName.getText().toString(),etBanksIdcardPhoneNum.getText().toString(),reqsn,etBanksIdcardYzm.getText().toString());
            }
            @Override
            protected void onExecuteSucceeded(String s) {
                hideLoadingDialog();
                ToastUtils.showTost(context, "实名认证成功");
                if (str.equals("1")) {
                    Intent intent = new Intent(AccountRealNameActivity.this, MainActivity.class);
