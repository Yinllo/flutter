package com.desjf.dsjr.cyview.base;
...
public class BaseDialog extends Dialog {
    ...
    public void config(int layoutResID_contentView, int gravity, int anim, float width_config, float height_config, boolean canceledOnTouchOutside) {
        ...
        lp.dimAmount = 0.2f;
        window.setBackgroundDrawableResource(R.drawable.cy_dialog_bg);//设置对话框边框背景,必须在代码中设置对话框背景，不然对话框背景是黑色的
        ...
        if (width_config != 0 && height_config != 0) {
            ...
            window.setLayout((int) (ScreenUtils.getScreenWidth(context) * width_config), (int) (ScreenUtils.getScreenHeight(context) * height_config));
