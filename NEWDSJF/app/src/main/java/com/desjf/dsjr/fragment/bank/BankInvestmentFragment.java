...
import com.desjf.dsjr.adapter.bankAdapter.BankFundDetailsInvestmentAdapter;
...
public class BankInvestmentFragment extends BaseFragment {
    ...
    private BankFundDetailsInvestmentAdapter myFundDetailsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (null == rootView) {
            rootView = inflater.inflate(R.layout.fragment_investment, null);
...
//        CallUtils.call(getActivity(), BankHttpUtils.getHttpRequestService().getUserAllMessage(PreferenceCache.getToken(), i + "", "20","E"), new CallUtils.MyCallListener() {
//            @Override
...
//            }
//        });
        CallUtil.call(getActivity(), BankHttpUtils.getHttpRequestService().getUserAllMessage(PreferenceCache.getToken(), i + "", maxCount+"","E"), new CallUtil.MyCallListener() {
            @Override
            public void onRespnseSuccess(String jsonString) {
                hideLoadingDialog();
                BankAccountFundDetailsModel bankPresentRecordModel= JSON.parseObject(jsonString,BankAccountFundDetailsModel.class);
...
//        linearLayoutManager = new LinearLayoutManager(getActivity());
        if(jyRecordModels==null){
            ...
            if (jyRecordModelList.size() != 0) {
                if (i == 1) {
                    myFundDetailsAdapter = new BankFundDetailsInvestmentAdapter(jyRecordModelList, getActivity());
